...
<details open="open">
  ...
  <ol>
    <li><a href="#-project-overview"> 🚀 Deployment Overview </a></li>
...
|--------------------|-------------|---------------------------------------|------------------|
| Public entry point | —           | https://conference.qgis.org           | Redirect only    |
...
- [Marco Bernasocchi](https://github.com/mbernasocchi) – Core Developer
